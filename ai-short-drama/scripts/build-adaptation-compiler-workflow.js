...
const workflow = {
  ...
  nodes: [
    ...
    codeNode('04a-require-claim', 'Stop When No Compiler Operation Claimed', `const context=$json.context;if(!context?.operation_id||!context?.claim_token)return [];return [{json:{context}}];`, [-580, 0]),
    codeNode('04a-compile', 'Run Nine-stage Constraint Compiler', compilerCode, [-360, 0]),
  ...
  connections: {
    ...
    'Claim and Load Frozen Compiler Inputs': {main: [[{node: 'Stop When No Compiler Operation Claimed', type: 'main', index: 0}]]},
    'Stop When No Compiler Operation Claimed': {main: [[{node: 'Run Nine-stage Constraint Compiler', type: 'main', index: 0}]]},
